...
class CoinPriceController: UIViewController,ChartViewDelegate {
    ...
    extension CoinPriceController: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    extension CoinPriceController: CoinManagerDelegate {
